...
- The stLFR2Supernova is a pipeline to de novo assemble the stLFR reads by Supernova Assembler. 
    -  the stLFR reads refer to the raw reads generated by stLFR technology from BGI [1].
